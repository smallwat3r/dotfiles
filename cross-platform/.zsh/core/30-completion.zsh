...
# Don't enable completion by default, as I realised I don't use this a lot.
# Still, provide a way to enable it on demand from calling `zsh_enable_completion`.

zsh_enable_completion() {
